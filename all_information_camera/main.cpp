...
#define DEV_USERNAME "peeklio"
#define DEV_PASSWORD "Gdhuemk"
...
int main(int argc, char* argv[])
{
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyDevice.soap, NULL, DEV_USERNAME, DEV_PASSWORD))
	{
		return -1;
	}
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyEvent.soap, NULL, DEV_USERNAME, DEV_PASSWORD))
	{
		return -1;
	}
...
if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyDevice.soap, NULL, DEV_USERNAME, DEV_PASSWORD))
	...
	if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, NULL, DEV_USERNAME, DEV_PASSWORD))
	{
		return -1;
	}
